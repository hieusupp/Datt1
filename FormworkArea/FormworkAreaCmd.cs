...
namespace AlphaBIM
{
    ...
    public class FormworkAreaCmd : IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            {
                tranGroup.Start("Formwork Area");

                FormworkAreaViewModel viewModel = new FormworkAreaViewModel(uidoc);
                FormworkAreaWindow window = new FormworkAreaWindow(viewModel);
