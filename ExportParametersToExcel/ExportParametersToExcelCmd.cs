    ...
    public class ExportScheduleToExcelCmd : IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            using (TransactionGroup tranGroup = new TransactionGroup(doc))
            {
                ...
                ExportParametersToExcelViewModel viewModel = new ExportParametersToExcelViewModel(uidoc);
                ExportParametersToExcelWindow window = new ExportParametersToExcelWindow(viewModel);
